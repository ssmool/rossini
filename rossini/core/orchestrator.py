...
class RossiniEngine:
    ...
    def plan_generation(self, user_prompt: str) -> Dict[str, Any]:
        """Queries local Ollama instance and enforces structured JSON output."""
        system_prompt = (
        ...
        try:
            ...
            # Parse raw text into JSON dictionary
            ...
            print(f"[Ollama Error] Connection failed: {e}. Falling back to default plan.")
